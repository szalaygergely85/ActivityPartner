...
public class FirebaseMessagingService {
     ...
     */
    public Map<String, Boolean> sendNotificationToMultipleDevices(List<String> fcmTokens,
                                                                   String title,
                                                                   String body,
     ...
     */
    public boolean sendNotificationWithNavigation(String fcmToken,
                                                   String title,
                                                   String body,
                                                   String screen,
                                                   Long entityId) {
    ...
    public void subscribeToTopic(String fcmToken, String topic) {
        ...
        try {
            ...
            log.info("Successfully subscribed to topic '{}': {} success, {} failure",
    ...
    public void unsubscribeFromTopic(String fcmToken, String topic) {
        ...
        try {
            ...
            log.info("Successfully unsubscribed from topic '{}': {} success, {} failure",
                    topic, response.getSuccessCount(), response.getFailureCount());
        } catch (FirebaseMessagingException e) {
