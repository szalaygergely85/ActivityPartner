...
public class ActivityMessageController {
  ...
  /** Send a message in activity chat POST /api/activities/{activityId}/messages */
  @PostMapping
  @PreAuthorize("isAuthenticated()")
  public ResponseEntity<ActivityMessageResponse> sendMessage(
      @PathVariable Long activityId, @Valid @RequestBody ActivityMessageRequest request) {
  ...
  /** Get all messages for an activity GET /api/activities/{activityId}/messages */
  @GetMapping
  @PreAuthorize("isAuthenticated()")
  ...
  /**
   * Get messages since a specific timestamp (for polling) GET
   * /api/activities/{activityId}/messages/since?timestamp=2024-01-01T12:00:00
   */
  @GetMapping("/since")
  @PreAuthorize("isAuthenticated()")
  public ResponseEntity<List<ActivityMessageResponse>> getMessagesSince(
    ...
    List<ActivityMessageResponse> messages =
        messageService.getMessagesSince(activityId, userId, timestamp);
    return ResponseEntity.ok(messages);
  }

  /** Get message count for an activity GET /api/activities/{activityId}/messages/count */
  @GetMapping("/count")
  @PreAuthorize("isAuthenticated()")
  ...
  /** Delete a message DELETE /api/activities/{activityId}/messages/{messageId} */
  @DeleteMapping("/{messageId}")
  @PreAuthorize("isAuthenticated()")
  public ResponseEntity<Map<String, String>> deleteMessage(
      @PathVariable Long activityId, @PathVariable Long messageId) {
