...
public interface ReviewRepository extends JpaRepository<Review, Long> {
  ...
  boolean existsByReviewerIdAndReviewedUserIdAndActivityId(
      Long reviewerId, Long reviewedUserId, Long activityId);

  // Find specific review
  Optional<Review> findByReviewerIdAndReviewedUserIdAndActivityId(
      Long reviewerId, Long reviewedUserId, Long activityId);
